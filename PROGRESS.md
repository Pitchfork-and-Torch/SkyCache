...
**Software version:** 1.35.0 (Village DTN store-and-forward)  
...
| Nexus fabric | Sim multi-node + village DTN (SHA-256/TTL/hop/custody) | Real batman-adv hop-forward on radio |
