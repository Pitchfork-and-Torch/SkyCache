...
Partner printable disaster drill: [`docs/disaster-drill-printable.html`](docs/disaster-drill-printable.html) (render from [`docs/disaster-drill.md`](docs/disaster-drill.md) via [`scripts/render_disaster_drill_printable.py`](scripts/render_disaster_drill_printable.py)).
...
![Version](https://img.shields.io/badge/version-1.35.0-0b1220)
...
| **1.34.2 Honesty / AEO** | Version badges, repo+portal `llms.txt`, advertised-version lockstep, receive-only honesty (not free commercial satellite broadband); no invented Mbps - [CHANGELOG](CHANGELOG.md) |
| **1.35.0 Village DTN** | Village store-and-forward: payload SHA-256, TTL, hop-limit, custody, integrity-gated USB mule, mesh hop-forward sim (`skycache dtn`); not Starlink; not RFC 9171 - **current** - [CHANGELOG](CHANGELOG.md) |
...
skycache dtn doctor|status|enqueue|export|import|verify|forward-sim
...
| Tool | Role |
|------|------|
| [ASCENT](https://github.com/Pitchfork-and-Torch/ascent) ([site](https://ascent.jonbailey.xyz/)) | Agent-native wire for store-and-forward links |
| [OrbitStack](https://github.com/Pitchfork-and-Torch/orbitstack) ([site](https://orbitstack.jonbailey.xyz/)) | LEO-aware congestion control |
| [VELA](https://github.com/Pitchfork-and-Torch/vela) ([site](https://vela.jonbailey.xyz/)) | Epoch language on top of LeoAware |
...
MIT License - see [`LICENSE`](LICENSE). Third-party tools commonly used alongside SkyCache are listed in [`NOTICE`](NOTICE).
