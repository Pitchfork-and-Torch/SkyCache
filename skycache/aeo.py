...
EDITION = "Village DTN store-and-forward"
HONEST_ONE_LINER = (
...
def render_llms_txt() -> str:
    ...
    lines = [
        ...
        "",
        "Q: Is village DTN Starlink, free broadband, or RFC 9171 Bundle Protocol?",
        "A: No. Store-and-forward over village mesh or USB mule with payload "
        "SHA-256, TTL, hop-limit, and custody. Unlicensed Wi-Fi/ISM only. "
        "Not commercial satellite broadband and not a complete BP implementation.",
        "",
    ]
    return "\n".join(lines)
